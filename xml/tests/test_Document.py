...
class DoctypeDeclarationTests(unittest.TestCase):
    ...
    def test_internal_general_entity_definition(self):
        ...
        self.assertEqual("blah", document.general_entities["entity"].expansion_text)
        self.assertEqual(Entity.Type.GENERAL, document.general_entities["entity"].type)
        self.assertEqual(False, document.general_entities["entity"].external)
    ...
    def test_external_general_entity_definition(self):
        with self.subTest("SYSTEM"):
            ...
            self.assertEqual("uri", document.general_entities["entity"].system_URI)
            self.assertEqual(Entity.Type.GENERAL, document.general_entities["entity"].type)
            self.assertEqual(True, document.general_entities["entity"].external)
            self.assertEqual(True, document.general_entities["entity"].parsed)
        with self.subTest("PUBLIC"):
            document = Document("")
            document._Document__parse_doctype_declaration("<!DOCTYPE root [<!ENTITY entity PUBLIC 'uri1' 'uri2'>]>")
            self.assertEqual("uri1", document.general_entities["entity"].public_URI)
            self.assertEqual("uri2", document.general_entities["entity"].system_URI)
            self.assertEqual(Entity.Type.GENERAL, document.general_entities["entity"].type)
            self.assertEqual(True, document.general_entities["entity"].external)
            self.assertEqual(True, document.general_entities["entity"].parsed)
    ...
    def test_unparsed_entity_definition(self):
        with self.subTest("SYSTEM"):
            ...
            self.assertEqual("notation", document.general_entities["entity"].notation)
        with self.subTest("PUBLIC"):
            document = Document("")
            document._Document__parse_doctype_declaration(
    ...
    def test_name_collisions(self):
        with self.subTest("General and parameter entities occupy different namespaces"):
            ...
            self.assertEqual("SOME OTHER TEXT", document.general_entities["entity"].expansion_text)
        with self.subTest("General entities"):
            ...
            self.assertEqual("SOME TEXT", document.general_entities["entity"].expansion_text)
    ...
    def test_parameter_entity_expansion(self):
        with self.subTest("In DTD"):
            ...
            self.assertEqual("SOME TEXT", document.general_entities["entity2"].expansion_text)
        with self.subTest("In general entity"):
            ...
            self.assertEqual("SOME TEXT", document.parameter_entities["entity"].expansion_text)
            self.assertEqual("SOME SOME TEXT OTHER TEXT", document.general_entities["entity2"].expansion_text)
